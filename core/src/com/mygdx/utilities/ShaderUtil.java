...
public class ShaderUtil {
    ...
    public static Logger getLogger() {
    	return Logger.getLogger(ShaderUtil.class.getName());
    }
    ...
    public static final class DefaultResourceLocator implements ResourceLocator {
	    ...
	    public InputStream getResourceAsStream(String ref) {
	        InputStream in = ShaderUtil.class.getClassLoader().getResourceAsStream(ref);
	    ...
	    public URL getResource(String ref) {
	        URL url = ShaderUtil.class.getClassLoader().getResource(ref);
	        if (url==null) {
	            try { 
