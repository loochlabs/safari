...
import com.mygdx.entities.esprites.SubWebSprite;
...
public abstract class EnvSub extends Environment{
    ...
    private EntitySprite mistSprite;//, bgPiece1;
    ...
    public void init(){
        ...
        mistSprite = new EntitySprite(
                mistSprite, 
                playerPos.x - mistSprite.sprite.getWidth()/2, 
                playerPos.y - mistSprite.sprite.getHeight()/2);
        
        mistSprite.sprite.setScale(3.0f * RATIO);
        
        this.spawnSprite(mistSprite);
    ...
    public void updateMist(){
        ...
        mistSprite.sprite.setPosition(dv.x - mistSprite.sprite.getWidth()/2, dv.y - mistSprite.sprite.getHeight()/2);
    }
    ...
    private void createBgSprites(){
        ...
        for(int i = 0; i < count; i++){
            ...
            this.spawnSprite(new SubBgSprite(v,boundingBody.getPosition().cpy().scl(PPM),width/2));
        }
