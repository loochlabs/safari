...
import com.mygdx.entities.pickups.items.Item_GlyphOne;
...
public class Wall_Glyph1 extends Wall_Lock{
    ...
    public Wall_Glyph1(Vector2 pos, float w, float h) {
        ...
        openSprite = new EntitySprite("wall1_open", false);
        openSprite.sprite.setScale(0.85f * RATIO);
        
        esprite = new EntitySprite("wall1_closed",false);
        esprite.sprite.setScale(0.85f * RATIO);
