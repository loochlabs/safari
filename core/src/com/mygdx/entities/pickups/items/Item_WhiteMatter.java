 ...
 * @author looch
 */
public class Item_WhiteMatter extends Pickup_Item {
 
    public Item_WhiteMatter(){
        this(new Vector2(0,0));
    }
    
    public Item_WhiteMatter(Vector2 pos) {
        super(pos, 20f*RATIO, 20f*RATIO);
        
        texture = MainGame.am.get(ResourceManager.ITEM_MATTER_WHITE);
