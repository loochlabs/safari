 ...
 * @author saynt
 */
public class DevLoadScreen extends Screen{
    ...
    public void render(SpriteBatch sb) {
        ...
        if(MainGame.am.update()){
            ...
            ScreenManager.setScreen(new DevScreen());
            
            MainGame.rm.secondaryLoad();
        }
        
        sb.begin();
        font.draw(sb, "" +MainGame.am.getProgress()+ "", MainGame.WIDTH*0.5f, MainGame.HEIGHT*0.7f);
        sb.end();
